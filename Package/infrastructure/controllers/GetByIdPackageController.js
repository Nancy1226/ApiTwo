...
exports.GetByIdPackageController = void 0;
class GetByIdPackageController {
    constructor(getByIdPackageUseCase) {
    ...
    run(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const pkg = yield this.getByIdPackageUseCase.run(id);
                if (pkg)
                    res.status(200).send({
                        status: 'success',
                        data: {
